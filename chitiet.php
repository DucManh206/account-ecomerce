...
$discount = ($product['old_price'] > 0 && $product['price'] > 0)
    ...
    : 0;
$availableStock = getAvailableStock($product_id);
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
            ...
            <div class="layout">
                ...
                <div class="nx-panel product-panel anim-in" style="animation-delay:0.08s;">
                    <div class="panel-meta">
                        ...
                        <?php endif; ?>
                        <span class="stock-pill">Còn <?php echo number_format($availableStock); ?> tài khoản</span>
                    </div>
                    ...
                    <div class="qty-row">
                        ...
                        <div class="nx-qty" style="gap:0;">
                            <button type="button" class="nx-qty-btn" onclick="changeQty(-1)"><i class="fa-solid fa-minus"></i></button>
                            <span class="nx-qty-val" id="qtyVal">1</span>
                            <button type="button" class="nx-qty-btn" onclick="changeQty(1)"><i class="fa-solid fa-plus"></i></button>
                        </div>
                        <span class="qty-label">Tối đa: <?php echo number_format($availableStock); ?></span>
                    </div>
                    ...
                    <?php if (!isset($_SESSION['username'])): ?>
                        <div class="login-note">
                            ...
                            Cần <a href="crud/auth/login.php">đăng nhập</a> để mua hàng
                        </div>
                    <?php endif; ?>
    ...
    <script>
        ...
        const maxStock = <?php echo max(1, intval($availableStock)); ?>;
