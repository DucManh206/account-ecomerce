...
<head>
    ...
    <title>Đăng ký thành viên - Account Shop</title>
    ...
    <div class="container">
        <div class="auth-container">
            <div class="auth-header">
                <h2>Tạo tài khoản</h2>
                <p>Đăng ký tài khoản để mua sắm tự động</p>
            </div>
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn-buy" style="margin-top: 10px;">Đăng ký</button>
            </form>
