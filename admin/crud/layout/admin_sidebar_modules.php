...
function admin_renderSidebar($currentPage = '')
{
    ...
    $navItems = [
        ...
        ['key' => 'types', 'label' => 'Loại sản phẩm', 'icon' => 'fa-tags', 'href' => $basePath . '/admin/crud/types/list.php'],
        ['key' => 'users', 'label' => 'Người dùng', 'icon' => 'fa-users', 'href' => $basePath . '/admin/crud/users/list.php'],
        ['key' => 'categories', 'label' => 'Danh mục', 'icon' => 'fa-layer-group', 'href' => $basePath . '/admin/crud/categories/list.php'],
