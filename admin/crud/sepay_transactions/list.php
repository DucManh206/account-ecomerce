<?php
/**
 * Admin SePay Transactions Log
 * Displays SePay transaction history
 */
...
$transactions = sepay_getProcessedTransactions(100);
                    ...
                    <tbody>
                        <?php foreach ($transactions as $tx):
                            $statusClass = [
                                ...
                                'matched' => 'nx-badge-success',
                                'failed' => 'nx-badge-danger',
                                'duplicate' => 'nx-badge-secondary'
                            ];
                            $statusText = [
                                'pending' => 'Chờ xử lý',
                                'matched' => 'Đã khớp',
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($tx['username'])): ?>
                                        <a href="../crud/users/list.php?search=<?php echo urlencode($tx['username']); ?>">
                                ...
                                <td>
                                    <span class="nx-badge <?php echo $statusClass[$tx['status']] ?? 'nx-badge-secondary'; ?>">
